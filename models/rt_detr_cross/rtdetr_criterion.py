...
class SetCriterion(nn.Module):
    ...
    def __init__(self, num_classes,matcher, weight_dict, losses, alpha=0.2, gamma=2.0, eos_coef=1e-4,  group_num=1):
    ...
    def loss_labels(self, outputs, targets, indices, num_boxes, log=True):
        ...
        loss_ce = sigmoid_focal_loss(src_logits, target_classes_onehot, num_boxes, alpha=self.alpha, gamma=2) * \
                  src_logits.shape[1]
    ...
    def forward(self, outputs, targets):
        ...
        init_indices = self.matcher(outputs_without_aux, targets)
        ...
        for loss in self.losses:
            l_dict = self.get_loss(loss, outputs, targets, init_indices, num_boxes)
