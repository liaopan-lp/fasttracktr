...
def associate_with_score_with_reid(detections, trackers, iou_threshold, lt, rt, lb, rb, previous_obs, vdc_weight,
...
def embedding_distance(tracks_feat, detections_feat, metric='cosine'):
    ...
    cost_matrix = np.zeros((len(tracks_feat), len(detections_feat)), dtype=np.float32)
