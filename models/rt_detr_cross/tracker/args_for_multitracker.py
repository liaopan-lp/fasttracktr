...
def make_parser():
    ...
    # tracking args
    parser.add_argument("--track_thresh", type=float, default=0.2, help="detection confidence threshold")
    ...
    parser.add_argument("--longterm_reid_weight", default=1, type=float, help="weight of appearance cost matrix when using long term reid features in 1st stage association")
    parser.add_argument("--longterm_reid_weight_low", default=1, type=float, help="weight of appearance cost matrix when using long term reid features in 2nd stage association")
